export const homeTranslations = {
  pt: {
    ...
    "foxGame.gameEndingSubtitle": "Voltando para a tela inicial",
    "foxGame.congratulations": "Parabéns!",
    "foxGame.completedAllLevels": "Você completou todos os níveis em",
    ...
    "foxGame.routes.1": "1 caminho principal",
    "foxGame.routes.2": "2 caminhos possíveis",
    "foxGame.routes.3": "3 rotas diferentes",
    "foxGame.routes.4": "4 caminhos alternativos",
    "foxGame.routes.5": "5 rotas para explorar",
  ...
  en: {
    ...
    "foxGame.startGame": "Start the game",
    "foxGame.pauseGame": "Pause the game",
    "foxGame.stopGame": "Stop the game and return to start",
    "foxGame.resetLevel": "Reset current level",
    "foxGame.gameEnding": "Ending Game",
    "foxGame.gameEndingMessage": "The game is ending...",
    "foxGame.gameEndingSubtitle": "Returning to start screen",
    "foxGame.congratulations": "Congratulations!",
    "foxGame.completedAllLevels": "You completed all levels in",
    ...
    "foxGame.routes.1": "1 main path",
    "foxGame.routes.2": "2 possible paths",
    "foxGame.routes.3": "3 different routes",
    "foxGame.routes.4": "4 alternative paths",
    "foxGame.routes.5": "5 routes to explore",
  ...
  es: {
    ...
    "foxGame.stopGame": "Detener el juego y volver al inicio",
    ...
    "foxGame.gameEndingSubtitle": "Volviendo a la pantalla de inicio",
    "foxGame.congratulations": "¡Felicitaciones!",
    "foxGame.completedAllLevels": "Completaste todos los niveles en",
    ...
    "foxGame.routes.1": "1 camino principal",
    "foxGame.routes.2": "2 caminos posibles",
    "foxGame.routes.3": "3 rutas diferentes",
    "foxGame.routes.4": "4 caminos alternativos",
    "foxGame.routes.5": "5 rutas para explorar",
    ...
    "whatsapp.autoReply":
      "¡Gracias por tu mensaje! Nuestro equipo responderá pronto. Para atención inmediata, llama al +55 (11) 9999-9999.",
  ...
  fr: {
    ...
    "foxGame.gameEndingSubtitle": "Retour à l'écran de démarrage",
    "foxGame.congratulations": "Félicitations !",
    "foxGame.completedAllLevels": "Vous avez terminé tous les niveaux en",
    ...
    "foxGame.routes.1": "1 chemin principal",
    "foxGame.routes.2": "2 chemins possibles",
    "foxGame.routes.3": "3 routes différentes",
    "foxGame.routes.4": "4 chemins alternatifs",
    "foxGame.routes.5": "5 routes à explorer",
  ...
  de: {
    ...
    "foxGame.namePlaceholder": "Dein Name hier...",
    ...
    "foxGame.gameEndingSubtitle": "Zurück zum Startbildschirm",
    "foxGame.congratulations": "Glückwunsch!",
    "foxGame.completedAllLevels": "Du hast alle Level abgeschlossen in",
    ...
    "foxGame.routes.1": "1 Hauptpfad",
    "foxGame.routes.2": "2 mögliche Pfade",
    "foxGame.routes.3": "3 verschiedene Routen",
    "foxGame.routes.4": "4 alternative Pfade",
    "foxGame.routes.5": "5 Routen zu erkunden",
    ...
    "whatsapp.autoReply":
      "Vielen Dank für Ihre Nachricht! Unser Team wird bald antworten. Für sofortige Hilfe rufen Sie +55 (11) 9999-9999 an.",
