export const homeTranslations = {
  pt: {
    ...
    "projects.ecommerce.category": "Varejo",
    "projects.ecommerce.description":
      "Plataforma completa de comércio eletrônico com gestão de produtos, pagamentos e logística.",

    "projects.hospital.title": "Sistema Hospitalar",
    "projects.hospital.category": "Saúde",
    "projects.hospital.description": "Sistema integrado de gestão hospitalar com prontuário eletrônico e telemedicina.",

    "projects.delivery.title": "App de Delivery",
    "projects.delivery.category": "Alimentação",
    "projects.delivery.description": "Aplicativo móvel para delivery de comida com rastreamento em tempo real.",

    "projects.banking.title": "Sistema Bancário",
    "projects.banking.category": "Financeiro",
    "projects.banking.description": "Plataforma de internet banking com segurança avançada e APIs de pagamento.",

    "projects.education.title": "Plataforma Educacional",
    "projects.education.category": "Educação",
    "projects.education.description": "Sistema de ensino à distância com videoconferência e gestão de cursos.",

    "projects.logistics.title": "Sistema Logístico",
    "projects.logistics.category": "Logística",
    "projects.logistics.description": "Plataforma de gestão logística com rastreamento e otimização de rotas.",
  ...
  en: {
    ...
    "projects.ecommerce.category": "Retail",
    "projects.ecommerce.description": "Complete e-commerce platform with product management, payments and logistics.",

    "projects.hospital.title": "Hospital System",
    "projects.hospital.category": "Healthcare",
    "projects.hospital.description": "Integrated hospital management system with electronic records and telemedicine.",

    "projects.delivery.title": "Delivery App",
    "projects.delivery.category": "Food",
    "projects.delivery.description": "Mobile food delivery app with real-time tracking.",

    "projects.banking.title": "Banking System",
    "projects.banking.category": "Financial",
    "projects.banking.description": "Internet banking platform with advanced security and payment APIs.",

    "projects.education.title": "Educational Platform",
    "projects.education.category": "Education",
    "projects.education.description": "Distance learning system with video conferencing and course management.",

    "projects.logistics.title": "Logistics System",
    "projects.logistics.category": "Logistics",
    "projects.logistics.description": "Logistics management platform with tracking and route optimization.",
  ...
  es: {
    ...
    "projects.ecommerce.category": "Retail",
    "projects.ecommerce.description":
      "Plataforma completa de comercio electrónico con gestión de productos, pagos y logística.",

    "projects.hospital.title": "Sistema Hospitalario",
    "projects.hospital.category": "Salud",
    "projects.hospital.description":
      "Sistema integrado de gestión hospitalaria con registros electrónicos y telemedicina.",

    "projects.delivery.title": "App de Delivery",
    "projects.delivery.category": "Alimentación",
    "projects.delivery.description": "Aplicación móvil de entrega de comida con seguimiento en tiempo real.",

    "projects.banking.title": "Sistema Bancario",
    "projects.banking.category": "Financiero",
    "projects.banking.description": "Plataforma de banca por internet con seguridad avanzada y APIs de pago.",

    "projects.education.title": "Plataforma Educativa",
    "projects.education.category": "Educación",
    "projects.education.description": "Sistema de aprendizaje a distancia con videoconferencia y gestión de cursos.",

    "projects.logistics.title": "Sistema Logístico",
    "projects.logistics.category": "Logística",
    "projects.logistics.description": "Plataforma de gestión logística con seguimiento y optimización de rutas.",
  ...
  fr: {
    ...
    "projects.ecommerce.category": "Commerce de Détail",
    "projects.ecommerce.description":
      "Plateforme e-commerce complète avec gestion des produits, paiements et logistique.",

    "projects.hospital.title": "Système Hospitalier",
    "projects.hospital.category": "Santé",
    "projects.hospital.description":
      "Système intégré de gestion hospitalière avec dossiers électroniques et télémédecine.",

    "projects.delivery.title": "App de Livraison",
    "projects.delivery.category": "Alimentation",
    "projects.delivery.description": "Application mobile de livraison de nourriture avec suivi en temps réel.",

    "projects.banking.title": "Système Bancaire",
    "projects.banking.category": "Financier",
    "projects.banking.description": "Plateforme de banque en ligne avec sécurité avancée et APIs de paiement.",

    "projects.education.title": "Plateforme Éducative",
    "projects.education.category": "Éducation",
    "projects.education.description": "Système d'apprentissage à distance avec visioconférence et gestion de cours.",

    "projects.logistics.title": "Système Logistique",
    "projects.logistics.category": "Logistique",
    "projects.logistics.description": "Plateforme de gestion logistique avec suivi et optimisation des itinéraires.",
  ...
  de: {
    ...
    "projects.ecommerce.category": "Einzelhandel",
    "projects.ecommerce.description":
      "Vollständige E-Commerce-Plattform mit Produktverwaltung, Zahlungen und Logistik.",

    "projects.hospital.title": "Krankenhaus-System",
    "projects.hospital.category": "Gesundheitswesen",
    "projects.hospital.description":
      "Integriertes Krankenhaus-Managementsystem mit elektronischen Akten und Telemedizin.",

    "projects.delivery.title": "Lieferungs-App",
    "projects.delivery.category": "Lebensmittel",
    "projects.delivery.description": "Mobile Lebensmittel-Lieferungs-App mit Echtzeit-Verfolgung.",

    "projects.banking.title": "Banking-System",
    "projects.banking.category": "Finanzwesen",
    "projects.banking.description": "Internet-Banking-Plattform mit fortschrittlicher Sicherheit und Zahlungs-APIs.",

    "projects.education.title": "Bildungsplattform",
    "projects.education.category": "Bildung",
    "projects.education.description": "Fernlernsystem mit Videokonferenzen und Kursverwaltung.",

    "projects.logistics.title": "Logistiksystem",
    "projects.logistics.category": "Logistik",
    "projects.logistics.description": "Logistik-Managementplattform mit Verfolgung und Routenoptimierung.",
