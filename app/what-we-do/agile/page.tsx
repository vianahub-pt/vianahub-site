        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center text-white mt-8">
              <h1 className="bg-viana-white text-viana-orange hover:bg-viana-yellow hover:text-viana-orange text-lg px-8 py-4 shadow-xl">{t("agile.hero.title")}</h1>
              <p className="text-xl  lg:text-2xl font-bold mb-8 drop-shadow-xl">{t("agile.hero.subtitle")}</p>
            </div>
          </div>
        </section>
