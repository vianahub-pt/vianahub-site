        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center text-white mt-8">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 drop-shadow-lg">{t("agile.hero.title")}</h1>
              <p className="text-xl lg:text-2xl mb-8 opacity-90 drop-shadow-md">{t("agile.hero.subtitle")}</p>
            </div>
          </div>
        </section>
