        ...
        <div className="container mx-auto px-4 relative z-10 h-full flex items-center justify-center">
          <div className="bg-white/50 dark:bg-black/50 text-orange-500 rounded-lg p-6 max-w-full overflow-hidden">
            <h1 className="text-orange-500 text-3xl sm:text-4xl lg:text-6xl font-bold text-center text-shadow break-words">
              <Train className="inline h-10 w-10 sm:h-12 sm:w-12 stroke-white dark:stroke-gray-400 icon-shadow mr-2 align-middle" />
      ...
      <section className="py-20 bg-yellow-100 dark:bg-gray-500">
        <div className="text-center mb-16">
          ...
          <Button
            ...
            aria-label="Contact us for railway solutions"
          >
