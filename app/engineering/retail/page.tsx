        ...
        <div className="container mx-auto px-4 relative z-10 h-full flex items-center justify-center">
          <div className="bg-white/50 dark:bg-black/50 text-orange-500 rounded-lg p-6 max-w-full overflow-hidden">
            <h1 className="text-orange-500 text-3xl sm:text-4xl lg:text-6xl font-bold text-center text-shadow break-words">
              <ShoppingCart className="inline h-10 w-10 sm:h-12 sm:w-12 stroke-white dark:stroke-gray-400 icon-shadow mr-2 align-middle" />
              {t("retail.hero.title")}
            </h1>
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              <span className="text-black dark:text-yellow-500">
                {t("retail.benefits.title.part1")}
              </span>{" "}
              <span className="text-orange-500">
                {t("retail.benefits.title.part2")}
              </span>
            </h2>
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              <span className="text-black">
                {t("retail.innovation.title.part1")}
              </span>{" "}
              <span className="text-orange-500">
                {t("retail.innovation.title.part2")}
              </span>
            </h2>
            ...
            <div className="relative">
              ...
              >
                <div className="aspect-[16/9] w-full max-w-3xl mx-auto">
                  <Image
                    src="/pages/technology-retail.jpg"
      ...
      <section className="py-20 bg-yellow-100 dark:bg-gray-600">
        <div className="text-center mb-16">
          ...
          <Button
            ...
            aria-label="Contact us for retail solutions"
          >
            {t("retail.cta.button")}
          </Button>
        </div>
