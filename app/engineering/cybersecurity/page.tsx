  ...
  function ProcessesCard({ service, index }: CardProps) {
    ...
    return (
      <motion.div
        ...
        className="h-full"
      >
        <Card className="bg-white hover:scale-105 transition-all duration-300 relative card-shadow border-none h-full">
          <CardContent className="p-8 text-center">
            <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center rounded-full bg-gray-200">
      ...
      <section className="py-20 bg-yellow-100 dark:bg-gray-600">
        <div className="text-center mb-16">
          ...
          <Button
            ...
            aria-label="Contact us for cybersecurity solutions"
          >
