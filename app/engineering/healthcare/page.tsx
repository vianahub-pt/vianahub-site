...
export default function HealthcarePageContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10 h-full flex items-center justify-center">
          <div className="bg-white/50 dark:bg-black/50 text-orange-400 dark:text-orange-400 border border-white rounded-lg p-6 ">
            <h1 className="text-orange-400 text-orange-400 text-4xl lg:text-6xl font-bold flex items-center justify-center text-shadow">
              <Heart className="h-12 w-12 stroke-white dark:stroke-gray-400 icon-shadow " />
            ...
            >
              <CarouselContent>
                {carousels.map((carousel, index) => (
                  ...
                  >
                    <Card className="h-full bg-gray-200 dark:bg-black border-none">
      ...
      {/* Service Section */}
      <section className="py-20 bg-gray-200 dark:bg-gray-600">
        <div className="container mx-auto px-4">
