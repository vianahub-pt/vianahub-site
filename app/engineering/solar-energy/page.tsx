              ...
              {[
                {
                  ...
                  description:
                    "Painéis solares de alta eficiência com garantia estendida.",
                },
                {
                  icon: Battery,
                ...
                },
                {
                  ...
                  title: "Inversores",
                  description:
                    "Inversores de última geração para máxima conversão.",
                },
                {
                  icon: TrendingUp,
                  title: "Monitoramento",
                  description:
                    "Sistema de monitoramento em tempo real da produção.",
                },
              ].map((feature, index) => (
                <Card
                  key={index}
