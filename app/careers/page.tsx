...
export default function CareersPage() {
  ...
  const getWordCloudImage = () => {
    const imageMap = {
      pt: "/junte-se-a-nossa-equipe.jpg",
      en: "/junte-se-a-nossa-equipe.jpg",
      es: "/junte-se-a-nossa-equipe.jpg",
      fr: "/junte-se-a-nossa-equipe.jpg",
      de: "/junte-se-a-nossa-equipe.jpg",
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Enviando dados para API externa:", applicationData)
                ...
                >
                  <CardHeader className="pb-3">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <Badge variant="secondary" className="ml-1 text-xs px-2 py-1 flex-shrink-0">
