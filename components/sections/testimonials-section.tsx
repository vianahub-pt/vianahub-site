...
const testimonials = [
  ...
  },
  {
    ...
    text: "Sou Claudio, da Claudio Eletricista, gerimos projetos de energias e construção civil em toda a região de Porto e Aveiro, em Portugal. Quero ressaltar o quão fundamental foi a VianaHub na criação do nosso site e implantação do nosso ERP Odoo.",
    rating: 4,
    ...
    <section className="py-32 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-20">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Testemunhos</h2>
