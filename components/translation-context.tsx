...
const translations = {
  ...
  es: {
    ...
    "chatbot.cta.subtitle": "Contáctanos y descubre cómo nuestro chatbot puede revolucionar tu atención al cliente",
  ...
  fr: {
    ...
    "agile.benefits.quality.description": "Focus sur la qualité grâce à des tests continus et des retours constants",
    ...
    "testimonials.maria.name": "Maria Silva",
    "testimonials.position": "PDG, TechStart",
    "testimonials.text":
    ...
    "testimonials.joao.name": "João Santos",
    "testimonials.position": "Directeur IT, HealthCorp",
    "testimonials.text":
    ...
    "testimonials.ana.name": "Ana Costa",
    "testimonials.position": "Fondatrice, EduTech",
    "testimonials.text":
    ...
    "testimonials.carlos.name": "Carlos Oliveira",
    "testimonials.position": "Responsable des Opérations, LogiFlow",
    "testimonials.text":
    ...
    "testimonials.lucia.name": "Lúcia Ferreira",
    "testimonials.position": "Directrice Commerciale, RetailMax",
    "testimonials.text":
    ...
    "chatbot.features.channels.title": "Multi-canal",
    "chatbot.features.channels.description": "Intégration avec multiples plateformes et canaux de communication",
    ...
    "chatbot.benefits.costs.description": "Réduisez les coûts opérationnels avec l'automatisation intelligente",
    ...
    "chatbot.cta.title": "Prêt à Implémenter?",
  ...
  de: {
    ...
    "agile.hero.subtitle":
      "Transformieren Sie Ihr Unternehmen mit effizienten agilen Praktiken und schnellen Ergebnissen",
    ...
    "agile.benefits.flexibility.description":
      "Schnelle Anpassung an Änderungen und sich ständig entwickelnde Anforderungen",
    ...
    "chatbot.features.subtitle": "Entdecken Sie die erweiterten Fähigkeiten unseres Chatbot-Systems",
    ...
    "chatbot.benefits.costs.description": "Reduzieren Sie Betriebskosten mit intelligenter Automatisierung",
    ...
    "chatbot.benefits.scalability.description": "Bedienen Sie tausende Kunden gleichzeitig ohne Einschränkungen",
    "chatbot.demo.title": "Chatbot-Demo",
    ...
    "chatbot.cta.button": "Mit Spezialist sprechen",
  },
}
