...
export function Ranking({ ranking, currentPlayerName, currentPlayerTime }: RankingProps) {
        ...
        {ranking.length === 0 ? (
          ...
          ranking.map((entry, index) => {
            const isCurrentPlayer =
              entry.name === currentPlayerName && currentPlayerTime && Math.abs(entry.time - currentPlayerTime) < 1
