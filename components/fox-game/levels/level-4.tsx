...
import {
  ...
  level4MazeMobile,
  type Position,
} from "../../../data/fox-game/mazes-level-4";
...
export function Level4({
  ...
  return (
    <motion.div
      ...
      className={`relative border-4 border-purple-600 rounded-lg overflow-hidden bg-purple-50 ${
        isMobile ? "mx-auto" : ""
      }`}
      style={{
      ...
      >
        {maze.grid.flat().map((cell, index) => {
          ...
          return (
            <div
              key={index}
              className={`border border-purple-200 ${getCellClass(
                x,
                y
