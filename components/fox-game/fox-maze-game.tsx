              ...
              >
                ...
                {!isMobile && (
                  <div className="bg-amber-50 border-2 border-amber-200 rounded-lg p-4 flex-1 flex flex-col overflow-hidden">
                    <h3 className="text-lg font-semibold text-amber-800 mb-3">{t("foxGame.rankingTitle")}</h3>
                    <div className="space-y-2 overflow-y-auto flex-1 min-h-0 max-h-48 lg:max-h-80">
                      {ranking.length === 0 ? (
                        <div className="text-center py-4 text-amber-600">
                          <p className="text-sm">{t("foxGame.rankingEmpty")}</p>
                          <p className="text-xs">{t("foxGame.rankingEmptySubtitle")}</p>
                        </div>
                      ) : (
                ...
                >
                  ...
                  <div className={`grid grid-cols-5 ${isMobile ? "gap-1" : "gap-1 lg:gap-2"}`}>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>{gameStarted ? t("foxGame.tooltipPause") : t("foxGame.tooltipStart")}</p>
                      </TooltipContent>
                    </Tooltip>
                ...
                <div className="space-y-4 flex-shrink-0">
                  ...
                  <AnimatePresence>
                    {gameStopped && (
                      ...
                      >
                        <h3 className="text-xl font-bold text-red-800 mb-2 text-center">{t("foxGame.endingTitle")}</h3>
                        <p className="text-red-700 text-center mb-2">
                          {t("foxGame.endingMessage")}
                          <br />
                          <span className="text-sm">{t("foxGame.endingSubtitle")}</span>
                        </p>
                    ...
                    {gameWon && !gameStopped && (
                      ...
                      >
                        ...
                        <p className="text-green-700 mb-4 text-center">
                          {t("foxGame.victoryMessage")} <strong>{getCurrentTime()}</strong>!
                        </p>
